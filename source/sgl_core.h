...
#ifndef CONFIG_SGL_HEAP_SIZE
#define CONFIG_SGL_HEAP_SIZE                     (10240)
#endif
...
#define sgl_rgb(r,g,b)                          (sgl_color_t){ .ch.blue    = (b) >> 3,         \
                                                               .ch.green   = (g) >> 2,         \
                                                               .ch.red     = (r) >> 3,}
#elif (CONFIG_SGL_FBDEV_PIXEL_DEPTH == SGL_COLOR_RGB233)
...
#endif
    uint8_t            mem_pool[CONFIG_SGL_HEAP_SIZE];
} sgl_system_t;
